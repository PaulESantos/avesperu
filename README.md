...
The `avesperu` package opens the door to Peru’s extraordinary avian
world, comprising approximately 1,892 species, making it one of the
world’s most diverse bird-rich countries. This comprehensive R package
provides users with access to the meticulously documented “List of the
Birds of Peru” by M. A. Plenge. It’s worth noting that avian taxonomy is
dynamic, with dramatic changes over time. Bird species categorization
has been refined based on articles, published photographs, sound
recordings from accredited institutions, and more.
